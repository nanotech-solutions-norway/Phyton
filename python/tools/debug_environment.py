"""Collect sanitized Python diagnostics for GitHub Actions."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default="baseline",
        help="Diagnostic detail level. Secrets are not printed.",
    )
    parser.add_argument(
        "--output-dir",
...
def collect_repo_structure(repo_root: Path) -> str:
    """Collect a limited repository file listing."""
...
def build_summary(diagnostic_level: str) -> dict[str, Any]:
    """Build a sanitized diagnostic summary."""
...
def main() -> int:
    """Write requested diagnostics to artifacts."""
    ...
    print("Python debug diagnostics completed. Artifacts were written safely.")
    return 0
